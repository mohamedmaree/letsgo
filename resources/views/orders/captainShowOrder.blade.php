...
<body> 
		...
		<div class="panel panel-flat">	
        	<table class="table datatable-basic">
						<tr>
							<td>{{trans('user.start_point')}} </td>
							<td>{{$order->start_address}}</td>
						</tr>
                        <tr>
                            <td> {{trans('user.end_point')}} </td>
                            <td>{{$order->end_address}}</td>
                        </tr>
                        <tr>
                           <td> {{trans('user.final_price')}}</td>
                           <td>{{$order->price}} {{$order->{"currency_$lang"} }}</td>
                        </tr>   
                        <tr>
                           <td> {{trans('user.coupon_discount')}}</td>
                           <td>{{$order->coupon_discount}} {{$order->{"currency_$lang"} }}</td>
                        </tr> 
                        <tr>
                           <td> {{trans('user.total_paid_cash')}} </td>
                           <td> {{$order->total_payments}} {{$order->{"currency_$lang"} }}</td>
                        </tr>
                        <tr>
                           <td> {{trans('user.payment_type')}} </td>
                           <td>{{($order->payment_type=='cash')? trans('user.cash') : trans('user.credit')}}</td>
                        </tr> 
                        <tr>
                           <td> {{trans('user.distance')}}</td>
                           <td>{{$order->distance}}</td>
                        </tr>
                        <tr>
                           <td> {{trans('user.period')}} </td>
                           <td>{{$order->period}}</td>
                        </tr>
                        <tr>
                           <td> {{trans('user.initial_wait')}} </td>
                           <td>{{$order->initial_wait}}</td>
                        </tr>
                        <tr>
                           <td>{{trans('user.during_order_wait')}} </td>
                           <td>{{$order->during_order_wait}}</td>
                        </tr>
                        <tr>
                           <td> {{trans('user.reception_time')}} </td>
                           <td>{{$order->reception_time}}</td>
                        </tr>
                        <tr>
                           <td> {{trans('user.end_journey_time')}}</td>
