                    ...
                    <form action="{{route('admin/login')}}" method="POST" role="form" class="form-validate">
                        ...
                        <div class="panel panel-body login-form">
                            <div class="text-center">
                                ...
                                <h5 class="content-group"> تسجيل دخول <small class="display-block"> لوحة تحكم سفراء {{setting('site_title')}} </small></h5>
                                {{session('error')}}
                            </div>

                            <div class="form-group ">
                                <input type="email" class="form-control" placeholder="البريد الالكترونى" name="email" required="required">
