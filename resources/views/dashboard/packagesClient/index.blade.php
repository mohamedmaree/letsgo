...
<div class="panel panel-flat">
	<div class="panel-heading">
		<h5 class="panel-title">قائمة باقات الاشتراك للعملاء</h5>
					...
					<ul class="icons-list">
						<li class="dropdown">
							...
							<ul class="dropdown-menu dropdown-menu-right">
								...
								<form action="{{route('DeleteClientPackage')}}" method="POST" id="DeleteCouponForm">
									{{csrf_field()}}
	  ...
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	        <div class="row">
	        	<form action="{{route('createClientPackage')}}" method="POST"  enctype="multipart/form-data" >
	        		{{csrf_field()}}
	...
	<div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	        	<form action="{{route('updateClientPackage')}}" method="POST"  enctype="multipart/form-data" >
	        		{{csrf_field()}}
