...
<div class="panel panel-flat">
	<div class="panel-heading">
		<h5 class="panel-title">قائمة عروض العملاء</h5>
					...
					<ul class="icons-list">
						<li class="dropdown">
							...
							<ul class="dropdown-menu dropdown-menu-right">
								...
								<form action="{{route('DeleteOffer')}}" method="POST" id="DeleteCouponForm">
									{{csrf_field()}}
	  ...
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	        <div class="row">
	        	<form action="{{route('createOffer')}}" method="POST"  enctype="multipart/form-data" >
	        		{{csrf_field()}}
