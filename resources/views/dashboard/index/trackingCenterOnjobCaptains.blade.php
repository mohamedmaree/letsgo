              ...
              @endif
                ...
                @else
                    setInterval(function(){
                          setMapOnAll(null);
                          markers = [];
                          $.get("<?=url('admin/getOnjobCaptainsLocation');?>",'',function(results){
