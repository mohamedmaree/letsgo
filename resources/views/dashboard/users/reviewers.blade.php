...
<div class="panel panel-flat">
	<div class="panel-heading">
		<h5 class="panel-title">قائمة المراجعين</h5>
	...
	<div class="panel-body">
		<div class="row">
			...
			<div class="col-xs-2">
				<a href="{{route('downloadReviewers')}}"><button class="btn btn-block btn-float btn-float-lg correspondent" style="background-color:#1b926c; color:#fff;" type="button" ><i class="fa fa-file-excel-o"></i> <span>تحميل Excel </span></button></a>
			</div>	
			<div class="col-xs-2">
...
<form action="{{route('deleteUsers')}}" method="POST"  id="removeAllForm">
	...
	<table class="table datatable-basic">
		<thead>
			<tr>
				...
				<th>الهاتف</th>
				<th>الرصيد</th>
				<th>قيمه مراجعه طلب</th>
				<th> عدد طلبات تم مراجعتها</th>
				<th> عدد طلبات مقبولة</th>
				<th> عدد طلبات مرفوضة</th>
				<th>تاريخ الاضافه</th>
				<th>التحكم</th>
				<th>
		...
		<tbody>
			@foreach($users as $u)
				<tr id="row-{{$u->id}}">
					...
					<td>0{{$u->phone}}</td>
					<td>{{$u->balance}}</td>
					<td>{{$u->review_order_value}}</td>
					<td>{{$u->num_reviewed_orders}}</td>
					<td><a href="{{ route('reviewerAgreedUsersMeta',$u->id) }}">{{$u->num_review_accepted_orders}}</a></td>
					<td><a href="{{ route('reviewerRefusedUsersMeta',$u->id) }}">{{$u->num_review_refused_orders}}</a></td>
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu dropdown-menu-right">
								...
								<li>
									...
									data-reviewordervalue="{{$u->review_order_value}}" 
								...
								<!-- add coupon-->
								{{-- <li>
									<a href="#" data-toggle="modal" data-target="#exampleModal5" class="AddcouponUser" 
										data-id="{{$u->id}}"
										data-name="{{$u->name}}" >
									<i class="glyphicon glyphicon-gift"></i>اضافة كوبون
									</a>
								</li>											 --}}
								<!-- comments-->
								{{-- <li>
								...
								{{-- <li>
									<a href="#" data-toggle="modal" data-target="#exampleModal6" class="AddBlock" 
										...
										data-name="{{$u->name}}" 
										>
									<i class="icon-lock"></i>حظر الطلبات
									</a>
								</li>										 --}}
								<!-- delete button -->
								@if($u->role != 1)  
	      ...
	      <div class="modal-body">
	        <div class="row">
	        	<form action="{{route('adduser')}}" method="POST" enctype="multipart/form-data">
	        		{{csrf_field()}}
					<input type="hidden" name="type" value="reviewer" >
	        		...
	        		<div class="row">
						...
						<div class="col-sm-7">
		        			<input type="number" name="review_order_value" min="0" class="form-control" placeholder="قيمة مراجعة الطلب" step="0.01"> 
		        		</div>
		        		<div class="col-sm-2">
	      ...
	      <div class="modal-body">
	        	<form action="{{route('updateuser')}}" method="post" enctype="multipart/form-data">
	        		...
	        		<div class="row">
						...
						<div class="col-sm-7">
		        			<input type="number" name="edit_review_order_value" min="0" class="form-control" placeholder="قيمة مراجعة الطلب" step="0.01"> 
		        		</div>
	        		</div>
	...
	<div class="modal fade" id="exampleModal3" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
			  <div class="modal-header">
			    <h5 class="modal-title" id="exampleModalLabel">مراسلة ادراة التطبيق</span></h5>
			  </div>
			  <div class="modal-body">
			    <div class="row">
					<div class="tabbable">
						...
						<div class="tab-content">
							...
							<div class="tab-pane" id="colored-rounded-justified-tab1">
							    <div class="row">
							    	<form action="{{route('emailSupervisiors')}}" method="POST" enctype="multipart/form-data">
							    		{{csrf_field()}}
							    		<div class="col-sm-12">
							...
							<div class="tab-pane active" id="colored-rounded-justified-tab2">
							    <div class="row">
							    	<form action="{{route('SmsMessageSupervisiors')}}" method="POST" enctype="multipart/form-data">
							    		{{csrf_field()}}
							    		<div class="col-sm-12">
							...
							<div class="tab-pane" id="colored-rounded-justified-tab3">
							    <div class="row">
							    	<form action="{{route('notificationSupervisiors')}}" method="POST" enctype="multipart/form-data">
							    		{{csrf_field()}}
							    		<div class="col-sm-12">
	...
	<div class="modal fade" id="exampleModal6" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
			  <div class="modal-header">
			    <h5 class="modal-title" id="exampleModalLabel">حظر الطلبات :  <span class="reverName"></span></h5>
			  </div>
			  <div class="modal-body">
			    <div class="row">
					<div class="tabbable">
...
<script type="text/javascript">
	...
	$('.openEditmodal').on('click',function(){
		...
		var review_order_value    = $(this).data('reviewordervalue')
		...
		$("input[name='edit_review_order_value']")   .val(review_order_value)
