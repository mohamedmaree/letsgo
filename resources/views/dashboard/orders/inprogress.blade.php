...
<div class="panel panel-flat">
	<div class="panel-heading">
		<h5 class="panel-title">الرحلات قيد التنفيذ</h5>
	...
	<div class="panel-body">
		<div class="row">
			...
			<div class="col-xs-3">
				<a href="{{route('downloadInprogressOrders')}}"><button class="btn btn-block btn-float btn-float-lg correspondent" style="background-color:#1b926c; color:#fff;" type="button" ><i class="fa fa-file-excel-o"></i> <span>تحميل Excel </span></button></a>
			</div>				
		</div>
	</div>
	<!-- /buttons -->
