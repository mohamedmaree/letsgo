        ...
        <div class="page-content">
            ...
            <div class="content-wrapper">
                ...
                <div class="content">
                    ...
                    <form action="{{route('remove-account')}}" method="POST" role="form" class="form-validate">
                        {{csrf_field()}}
                        <div class="panel panel-body login-form">
                            <div class="text-center">
                                <div class="icon-object border-slate-300 text-slate-300"><i class="icon-reading"></i></div>
                                <h5 class="content-group"> حذف الحساب <small class="display-block"> {{setting('site_title')}} </small></h5>
                                {{session('error')}}
                            </div>

                            <div class="form-group ">
                                <input type="text" class="form-control" placeholder="رقم الهاتف" name="phone" required="required">
